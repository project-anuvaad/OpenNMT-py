...
patterns = {
    ...
    "p6" : { "regex":r'(NnUuMm.,)\s(0NnUuMm+)', "description":"remove space between number separated by ," },
    "p7" : { "regex":r'(NnUuMm..)\s(0NnUuMm+)', "description":"remove space between number separated by ." }
}
